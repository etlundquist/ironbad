...
from app.schemas import StandardClauseRule, StandardClauseRuleCreate, StandardClauseRuleUpdate
from app.database import get_db
from app.constants import MAX_STANDARD_CLAUSE_RULES
...
async def create_standard_clause_rule(clause_id: UUID, request: StandardClauseRuleCreate, db: AsyncSession = Depends(get_db)) -> StandardClauseRule:
    ...
    if rules_count > MAX_STANDARD_CLAUSE_RULES:
