...
from app.features.workflows.schemas import ContractAnalysisJob, ContractIngestionJob
from app.enums import ContractStatus, JobStatus
from app.api.deps import get_db
from app.features.workflows.tasks import analyze_contract, ingest_contract
...
@router.post("/contracts/ingest", tags=["workflows"])
...
@router.post("/contracts/analyze", tags=["workflows"])
